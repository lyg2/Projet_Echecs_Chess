...
QT_MOC_LITERAL(1, 5, 15), // "changerPosition"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 5), // "int**"
QT_MOC_LITERAL(4, 28, 8), // "position"
QT_MOC_LITERAL(5, 37, 12), // "changerPiece"
QT_MOC_LITERAL(6, 50, 6), // "string"
QT_MOC_LITERAL(7, 57, 5) // "piece"

    },
    "Game\0changerPosition\0\0int**\0position\0"
    "changerPiece\0string\0piece"
};
...
void Game::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Game::changerPosition)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Game::changerPiece)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Game::changerPosition(int * * _t1)
{
...
// SIGNAL 1
void Game::changerPiece(string _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
